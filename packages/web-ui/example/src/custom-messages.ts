...
import type { AgentMessage, MessageRenderer } from "@styrene-lab/pi-web-ui";
import { defaultConvertToLlm, registerMessageRenderer } from "@styrene-lab/pi-web-ui";
...
declare module "@styrene-lab/pi-agent-core" {
