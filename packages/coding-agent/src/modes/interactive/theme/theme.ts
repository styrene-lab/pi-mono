...
import type { EditorTheme, MarkdownTheme, SelectListTheme } from "@cwilson613/pi-tui";
...
const THEME_KEY = Symbol.for("@cwilson613/pi-coding-agent:theme");
...
export function getSettingsListTheme(): import("@cwilson613/pi-tui").SettingsListTheme {
	return {
