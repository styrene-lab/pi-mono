...
import type { EditorTheme, MarkdownTheme, SelectListTheme } from "@styrene-lab/pi-tui";
...
const ThemeJsonSchema = Type.Object({
	...
	colors: Type.Object({
		...
		toolDiffAddedHighlight: Type.Optional(ColorValueSchema),
		toolDiffRemovedHighlight: Type.Optional(ColorValueSchema),
...
export type ThemeBg =
	...
	| "toolDiffAddedBg"
	| "toolDiffRemovedBg"
	| "toolDiffAddedHighlight"
	| "toolDiffRemovedHighlight";
...
const THEME_KEY = Symbol.for("@styrene-lab/pi-coding-agent:theme");
...
export function getSettingsListTheme(): import("@styrene-lab/pi-tui").SettingsListTheme {
	return {
